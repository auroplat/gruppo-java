...
public class GestioneMagazzinoController {
    ...
    public StatoDisponibilita controllaPezzo(String idPezzo) {return magazzinoService.controllaDisponibilita(idPezzo);}

    public VoceMagazzino cercaPezzo(String idPezzo) {return magazzinoService.cercaPezzo(idPezzo);}
    ...
    public void aggiungiPezzi(TipoPezzo tipoPezzo, int quantita, double kmMax, int tempoMax) {
        magazzinoService.aggiungiPezzi(tipoPezzo, quantita, kmMax, tempoMax);
    }

    public void creaMacchina(String idMacchina) {magazzinoService.creaMacchina(idMacchina);}

    public void cambiaPezzo(String idMacchina, TipoPezzo tipoPezzo, String idNuovoPezzo) {
        magazzinoService.cambiaPezzo(idMacchina, tipoPezzo, idNuovoPezzo);
    }
}
