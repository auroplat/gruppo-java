...
public final class SessioneFactory {
    ...
    public static Sessione crea(
        ...
        Objects.requireNonNull(
                tipo,
                "Il tipo di sessione non può essere null"
        );
    ...
    private static String testoObbligatorio(
            String valore,
            String nome) {
    ...
    private static int interoPositivoObbligatorio(
            String valore,
            String nome) {

        String normalizzato =
                testoObbligatorio(valore, nome);
